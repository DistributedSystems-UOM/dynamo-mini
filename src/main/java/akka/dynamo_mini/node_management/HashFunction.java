...
public class HashFunction {
    ...
    public Integer hash(String key) {
        ...
        Long partOfHash = Long.parseLong(completeHashVal.substring(0, 14)); // get the first 15 digit of generated hash
    ...
    public Integer hash(Object key){
        ...
        Long partOfHash = Long.parseLong(completeHashVal.substring(0, 14)); 
